...
- `app/composables/` — auto-imported too. `useProjects()` is the single source for the portfolio list, shared by the home page's "Selected work" strip and the portfolio page.
